...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8-database-administrator-26.png"))); // NOI18N
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CSE", "EEE", "EE", "ME", "CE" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            st.executeUpdate("Insert into student(course_Name, branch_Name ,name , father_Name, rollNo , gender) values('"+Course+"' , '"+BranchName+"' ,'"+Name+"' ,'"+FatherName+"' ,'"+RollNumber+"', '"+Gender+"'  )");
